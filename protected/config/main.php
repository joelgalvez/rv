...
// Load the environment specific settings (ie. database settings). They will
// be incorporated in the returned array.
...
return array(
  ...
  'components' => array(
    ...
    'log' => array(
      ...
      'routes' => array(
        ...
        array(
          'class' => 'CWebLogRoute', 'levels' => 'error, warning, trace',
    ...
    'urlManager' => array(
      ...
      'rules' => array(
        ...
        'en/<enname>/<y>/<cc>/<uu>' => array(
          'webPage/page', 'caseSensitive' => false
        ),
        'en/<enname>/<y>/<cc>/' => 'webPage/page',
        'en/<enname>/<y>' => 'webPage/page',
        'nl/<nlname>/<y>/<cc>/<uu>' => array(
          'webPage/page', 'caseSensitive' => false
        ),
        ...
        'student/<uname>' => array(
          'user/userInfo', 'caseSensitive' => false
        ),
        'nl' => 'webPage/index',
        'en' => 'webPage/index',
      )
  ...
  'params' => array(
    ...
    'thumbFolder' => '/u/thumb/',
    'imageSize' => array(
      740, 700, 650, 600, 500, 400, 300, 250, 200, 150, 50
    ),
    'defaultLn' => 2,
    'resultPerPage' => 25,
    'maxChangeRequest' => 3,
    'defaultRules' => array(
      ...
      array(
        'allow', 'actions' => array(
          ...
          'authenticated'
        ),//TODO: Need to check is it the same user
      ),
      array(
        'allow',
        'actions' => array(
    ...
    'adminDefaultRules' => array(
      array(
        'allow',
        'actions' => array(
          'list', 'show', 'create', 'update', 'admin', 'delete'
        ),
        'roles' => array(
          'administrator'
        ),
